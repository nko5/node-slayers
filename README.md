Node SLayer's Project
## Quick Start

~~~sh
# getting the code
git clone git@github.com:nko5/node-slayers.git && cd ./node-slayers.git/
...
~~~html
<iframe src="http://nodeknockout.com/iframe/node-slayers.git" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
